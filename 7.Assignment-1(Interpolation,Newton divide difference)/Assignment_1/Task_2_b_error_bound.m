...
%fprintf('The absolute maximum value of fourth derivative of f(x) is : 
%5.4f\n',max_fx)
...
%Plot function,f(x)=ln(x) and Polynomial,P(x)= (0.1970056*x^3)-
%(1.06529*x^2)+(2.5324*x)-(1.66686) 
func = log(nodes);
plot(nodes,func,'bo');
...
polynomial = (0.1970056*x_nodes.^3)-(1.06529*x_nodes.^2)+(2.5324*x_nodes.^1)-...
    (1.66686);
